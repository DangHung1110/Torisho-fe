...
export function LoginForm() {
  ...
  return (
    <div className="torisho-auth-grid bg-white text-[#211a12]">
      <aside className="relative hidden min-h-screen overflow-hidden bg-[#f5a623] px-10 py-8 text-white lg:flex lg:flex-col lg:justify-between">
        <div
        ...
        <Link href="/" className="relative z-10 flex w-fit items-center gap-3 no-underline">
          <span className="font-[var(--font-display)] text-3xl font-bold text-white">Torisho</span>
        </Link>

        <div className="relative z-10 mx-auto flex max-w-[460px] flex-1 flex-col items-center justify-center pb-5 text-center">
          <div className="relative h-[260px] w-[260px] bg-white shadow-[0_22px_38px_rgba(87,55,7,0.18)] ring-1 ring-white/60">
            <Image
              src={loginArtwork}
          ...
          <p className="torisho-jp mt-8 text-4xl font-bold leading-tight text-white drop-shadow-sm">
            {quoteText}
          </p>
          <p className="torisho-display mt-3 max-w-[400px] text-xl italic leading-snug text-white/90">
            &quot;A journey of a thousand miles begins with a single step&quot;
          </p>
        </div>
      </aside>

      <main className="flex min-h-screen w-full items-center justify-center bg-[#fffdfb] py-6 lg:py-5">
        <div className="torisho-auth-form">
          ...
          <div className="mb-7">
            <h1 className="torisho-display text-4xl font-bold leading-tight text-[#211a12]">
              Welcome back
            </h1>
            <p className="mt-2 text-lg text-[#3d2a17]">Continue your Japanese journey.</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <label className="block">
              <span className="mb-1.5 block text-[11px] font-extrabold uppercase tracking-[0.12em] text-[#3d2a17]">
                Username
              </span>
              <input
                value={username}
            ...
            <label className="block">
              <span className="mb-2 flex items-center justify-between">
                <span className="text-[11px] font-extrabold uppercase tracking-[0.12em] text-[#3d2a17]">
                  Password
                </span>
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex h-12 w-full items-center justify-center gap-2 rounded-full bg-[#f5a623] px-6 text-base font-bold text-[#291800] transition-all hover:bg-[#ffb955] disabled:cursor-not-allowed disabled:opacity-70"
            >
          ...
          <div className="space-y-4">
            <button
              ...
              className="flex h-12 w-full items-center justify-center gap-4 rounded-full border border-[#d7c3ae] bg-[#fff8f4] px-6 text-base font-medium text-[#211a12] transition-colors hover:bg-white"
            >
              <GoogleLogo />
            ...
            <button
              ...
              className="flex h-12 w-full items-center justify-center gap-4 rounded-full border border-[#d7c3ae] bg-[#f4e6d8] px-6 text-base font-medium text-[#665744] transition-colors hover:bg-[#eee0d2]"
            >
          ...
          <p className="mt-7 text-center text-sm text-[#3d2a17]">
